...
export default function Features() {
    return (
        <section className="py-5 bg-light feature-ctn">
            <div className="container">
                <div className="row  align-items-center ">
                    <div className="col-lg-4 mb-3 mb-lg-0 d-flex justify-content-center">
                        <div className="d-inline-block">
                            <div className="media align-items-center d-flex  ">
                                <svg width="48" height="48" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" style={{ padding: "0 2px", marginRight: "10px" }}>
                                    <path d="M12 0c6.623 0 12 5.377 12 12s-5.377 12-12 12-12-5.377-12-12 5.377-12 12-12zm0 1c6.071 0 11 4.929 11 11s-4.929 11-11 11-11-4.929-11-11 4.929-11 11-11zm0 11h6v1h-7v-9h1v8z" transform="scale(1.8)" />
                                </svg>
